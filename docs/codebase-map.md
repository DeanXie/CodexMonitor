...
| Change Thread subscription/runtime observations or synthetic live detach | `src-tauri/src/shared/codex_core/thread_lifecycle_observation.rs`, `src-tauri/src/shared/codex_core/thread_lifecycle_observation_tests.rs`, `src-tauri/src/shared/codex_core/synthetic_live_detach_tests.rs`, `src-tauri/src/codex/mod.rs`, `src-tauri/src/bin/codex_monitor_daemon.rs`, `src-tauri/src/remote_backend/mod.rs`, `docs/phase-3-5-2c-subscription-release-lifecycle.md` |
