...
Status: **PASS / FROZEN**. Phase 3.4.0 is **FORENSICS COMPLETE**, Phase 3.4.1 is **PASS / FROZEN**, and Phase 3.4.3 Desktop Stale/Missing Projection Handling is **GO / NOT STARTED**.
...
Phase 3.4.3 Desktop Stale/Missing Projection Handling is the next and only development start point.
