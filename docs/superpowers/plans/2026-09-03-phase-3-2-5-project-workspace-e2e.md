...
- [x] **Step 1: Write literal fixture records**
...
- [x] **Step 2: Write table-driven acceptance tests against real shared-core code**
...
- [x] **Step 1: Preserve a minimal failing regression (not needed: no contract defect observed)**
...
- [x] **Step 2: Make the smallest production correction (not needed: no production correction made)**

Do not add new identity types, resolvers, persistence, readers, UI, or write paths.

- [x] **Step 3: Verify GREEN and affected regressions (covered by unchanged frozen regressions)**
...
- [x] **Step 1: Capture pre-probe environment and Desktop private-state hashes**
...
- [x] **Step 2: Create one isolated CLI Thread**
...
- [x] **Step 3: Create one isolated Monitor/app-server Thread**
...
- [x] **Step 4: Read Phase 3.1 A2 and Desktop assignment evidence**
...
- [x] **Step 5: Prove read-only behavior**
...
- [x] **Step 3: Verify no order dependence**
...
**Files:**
- Create: `docs/phase-3-2-project-workspace-e2e.md`
...
- [x] **Step 2: Scan evidence for sensitive content**
...
- [x] **Step 3: Validate JSON and canonical state vocabulary**
...
- [x] **Step 1: Run focused and frozen regressions**
...
- [x] **Step 3: Audit scope and private-state immutability**
...
- [x] **Step 4: Commit by bounded concern**
