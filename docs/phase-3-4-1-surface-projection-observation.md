...
Status: **PASS / FROZEN**. Phase 3.4.0 is **FORENSICS COMPLETE**, Phase 3.4.2 through Phase 3.4.4 and Phase 3.4.5a are **PASS / FROZEN**, and Phase 3.4.5 / Phase 3.4 are **PASS / COMPLETE**. Phase 3.5.0 is **FORENSICS COMPLETE** and Phase 3.5.1 is **GO / NOT STARTED**.
...
Phase 3.4.2 through Phase 3.4.4 and Phase 3.4.5a are implemented and frozen. Phase 3.4.5 and Phase 3.4 are complete. Phase 3.5.0 forensics are complete; Phase 3.5.1 is the next and only development start point.
